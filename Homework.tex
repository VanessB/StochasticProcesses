...
\begin{exercise}
    Для винеровского процесса $ W_t $ вычислите условное математическое ожидание и дисперсию
    $ \expect (W_t \mid W_s = x) $ и $ \dispersion (W_t \mid W_s = x) $ для произвольных $ t \geqslant 0 $, $ s \geqslant 0 $, $ x \in \reals $.
\end{exercise}
