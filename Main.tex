...
\include{chapters/basics.tex}       % Общие сведения.
\include{chapters/special.tex}      % Важные примеры случайных процессов.
\include{chapters/calculus.tex}     % Элементы стохастического анализа.
\include{chapters/stationarity.tex} % Стационарность.
\include{chapters/ergodicity.tex}   % Эргодичность.
